      ...
      if (m === "create") {
        const schemas: Record<string, z.ZodTypeAny> = {
          "frame": z.object({
            ...
            children: flexJson(z.array(z.record(z.string(), z.unknown()))).optional().describe("Inline child nodes. Text: {type:\"text\", text, fontFamily?, fontSize?, fontColor?}. Frame: {type:\"frame\", name?, layoutMode?, fillColor?, children?}. Instance: {type:\"instance\", componentId, variantProperties?, properties?}. Component: {type:\"component\", name, children?}. Inside components: add componentPropertyName to auto-bind TEXT or INSTANCE_SWAP properties."),
          }).passthrough(),
