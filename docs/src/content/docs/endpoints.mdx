...
Vibma exposes **14 endpoint tools** instead of dozens of standalone tools. Each endpoint groups related operations behind a single tool with a `method` parameter — similar to a REST resource.
...
- **Reduces tool count** — 14 endpoints cover 75 methods
